...
func GetUserSettings(authID, userAgent, cookie, xBC string) (any, error) {
	url, endpoint := el.SettingsEndpoint()
...
func GetUserNotificationsSettings(authID, userAgent, cookie, xBC string) (any, error) {
	url, endpoint := el.NotificationsSettingsEndpoint()
	resp, err := Response(url, endpoint, authID, userAgent, cookie, xBC)
	if err != nil {
		return resp, err
	}
...
func GetUserRecommends(authID, userAgent, cookie, xBC string) (any, error) {
	url, endpoint := el.RecommendsEndpoint()
	resp, err := Response(url, endpoint, authID, userAgent, cookie, xBC)
	if err != nil {
		return resp, err
	}
